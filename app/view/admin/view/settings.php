                ...
                <form class="p-2 bg-accent border-1" action="admin" method="post">
                    <div class="flex wrap">
                        ...
                        <div class="column-md-6">
                            ...
                            <input class="form-input" type="text" id="uname" name="uname" value="<?php echo $_SESSION['uname']; ?>" placeholder="example123" minlength="4" disabled required><br>
                        </div>
